...
public class GridFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lv.setColumnWidth(getResources().getDimensionPixelOffset(R.dimen.apps_column_width));
        lv.setStretchMode(GridView.STRETCH_COLUMN_WIDTH);
        lv.setNumColumns(GridView.AUTO_FIT);
        lv.setHorizontalSpacing(getResources().getDimensionPixelOffset(R.dimen.apps_column_horizontal_spacing));
        lv.setVerticalSpacing(getResources().getDimensionPixelOffset(R.dimen.apps_column_vertical_spacing));
